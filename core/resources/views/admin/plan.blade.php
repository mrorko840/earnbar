                                ...
                                @forelse($plans as $plan)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Image')">
                                            <img src="{{asset('assets/images/plan/'. @$plan->image)}}" class="img-fluid img-thumbnail rounded" style="height: 50px">
                                        </td>
                ...
                <form id="addModalForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="image" id="image" placeholder="@lang('Plan Image')"
                                required>
