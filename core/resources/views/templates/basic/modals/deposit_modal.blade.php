                ...
                <div class="main-container">
                    <div class="container">
                        <form id="depositForm" action="{{ route('user.deposit.insert') }}" method="post">
                            ...
                            <!-- Select Method -->
                            <div id="methodSelect" class="card bg-default-secondary">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-auto">
                            ...
                            <div class="my-1" id="submitBtn">
                                {{-- <a href="javascript:void(0)" class="btn btn-default my-2 rounded w-100 menualBtn">Next Step</a> --}}
                                <button type="submit" class="btn btn-default my-2 rounded w-100 menualBtn">Next Step</button>
                            </div>
                        </form>
                    </div>
                </div>
