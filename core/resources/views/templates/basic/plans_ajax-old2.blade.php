            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-7">
                        ...
                        <p class="mb-0">Price: <b class="text-warning">{{ __(showAmount($plan->price)) }} {{ $general->cur_sym }}</b></p>
                        <p class="mb-0">Daily Earn: <b class="text-warning">{{ $plan->ads_rate }} {{ $general->cur_sym }} </b></p>
                        <p class="mb-0">Validity: <b class="text-warning">{{ $plan->validity }} Days</b></p>
                        <div class="mt-3">
