...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="homepage">
    ...
    <main class="flex-shrink-0 main has-footer">
        ...
        <div class="main-container">
                ...
                <div class="card bg-default-secondary shadow-default">
                    <div class="card-body">
                        ...
                        <div class="swiper-container addsendcarousel text-center">
                            <div class="swiper-wrapper mb-4 justify-content-center ">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#depositModal" class="swiper-slide text-white mx-3">
                                    <div class="icon icon-50 rounded-circle mb-2 bg-white-light"><span class="material-icons">add</span></div>
                                    <p><small>Deposit</small></p>
                                </a>
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#withdrawModal" class="swiper-slide text-white mx-3">
                                ...
                                <a href="javascript:void(0)" onclick="copyReferLink('{{ route('user.register') }}/{{ auth()->user()->username }}')" class="swiper-slide text-white mx-3">
                                    <div class="icon icon-50 rounded-circle mb-2 bg-white-light"><span class="material-icons">copy_all</span></div>
                                    <p><small>Invite</small></p>
                                </a>
                            </div>
                            <!-- Add Pagination -->
            ...
            <!--Deposit-->
            @if ( strlen($referrals['deposit']) > 10 )
                <div class="container mb-4">
                    <div class="card">
                        <div class="card-header">
