        ...
        <div class="main-container">
            ...
            <div class="container mb-4">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-default rounded" type="button" id="basic-addon2"
                            onclick="copyRefLink()">(<b class="text-white">{{$refUsers->count()}}</b>)</button>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <p class="text-secondary mb-1">Name: <b class="text-warning">{{ $data->firstname.' '.$data->lastname}}</b></p>
                                            <p class="text-secondary mb-0">Username: <b class="text-warning">{{ $data->username }}</b></p>
                                            <p class="text-secondary mb-0">Balance: <b class="text-warning">{{ showAmount($data->balance) }} {{$general->cur_sym}}</b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
